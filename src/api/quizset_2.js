var story = [
  "Jessica takes the ***",
  " to ***.",
  " There she visits her ***.",
  " Together, they are ***."
];
var questions = [
  {
    question: "Jessica takes the",
    answers: [
      {
        text: "rocket",
        src: "vehicles/1f680.svg"
      },

      {
        text: "helicopter",
        src: "vehicles/1f681.svg"
      },

      {
        text: "locomotive",
        src: "vehicles/1f682.svg"
      },

      {
        ...
        emojiList: [
          {
            text: "train1",
            src: "vehicles/1f684.svg"
          },

          {
            text: "train2",
            src: "vehicles/1f685.svg"
          },

          {
            text: "train3",
            src: "vehicles/1f686.svg"
          },

          {
            text: "metro",
            src: "vehicles/1f687.svg"
          },

          {
            text: "train4",
            src: "vehicles/1f688.svg"
          },

          {
            text: "train5",
            src: "vehicles/1f689.svg"
          },

          {
            text: "train6",
            src: "vehicles/1f69d.svg"
          }
        ]
      },

      {
        ...
        emojiList: [
          {
            text: "tram1",
            src: "vehicles/1f68a.svg"
          },

          {
            text: "tram2",
            src: "vehicles/1f68b.svg"
          }
        ]
      },

      {
        ...
        emojiList: [
          {
            text: "bus1",
            src: "vehicles/1f68c.svg"
          },

          {
            text: "bus2",
            src: "vehicles/1f68d.svg"
          }
        ]
      },
      ...
      {
        text: "trolleybus",
        src: "vehicles/1f68e.svg"
      },

      {
        text: "minibus",
        src: "vehicles/1f690.svg"
      },

      {
        text: "ambulance",
        src: "vehicles/1f691.svg"
      },

      {
        text: "fire truck",
        src: "vehicles/1f692.svg"
      },

      {
        ...
        emojiList: [
          {
            text: "policecar1",
            src: "vehicles/1f693.svg"
          },

          {
            text: "policecar2",
            src: "vehicles/1f694.svg"
          }
        ]
      },

      {
        ...
        emojiList: [
          {
            text: "taxi1",
            src: "vehicles/1f695.svg"
          },

          {
            text: "taxi2",
            src: "vehicles/1f696.svg"
          }
        ]
      },

      {
        ...
        emojiList: [
          {
            text: "car1",
            src: "vehicles/1f697.svg"
          },

          {
            text: "car2",
            src: "vehicles/1f698.svg"
          },

          {
            text: "car3",
            src: "vehicles/1f699.svg"
          }
        ]
      },
      ...
      {
        text: "truck",
        src: "vehicles/1f69b.svg"
      },

      {
        text: "tractor",
        src: "vehicles/1f69c.svg"
      },

      {
        text: "suspension railway",
        src: "vehicles/1f69f.svg"
      },

      {
        ...
        emojiList: [
          {
            text: "skilift1",
            src: "vehicles/1f6a0.svg"
          },

          {
            text: "skilift2",
            src: "vehicles/1f6a1.svg"
          }
        ]
      },
      ...
      {
        text: "ship",
        src: "vehicles/1f6a2.svg"
      },

      {
        text: "speedboat",
        src: "vehicles/1f6a4.svg"
      },

      {
        text: "bicycle",
        src: "vehicles/1f6b2.svg"
      },

      {
        text: "motor boat",
        src: "vehicles/1f6e5.svg"
      },

      {
        ...
        emojiList: [
          {
            text: "airplane1",
            src: "vehicles/1f6e9.svg"
          },

          {
            text: "airplane2",
            src: "vehicles/1f6eb.svg"
          },

          {
            text: "airplane3",
            src: "vehicles/1f6ec.svg"
          },

          {
            text: "airplane4",
            src: "vehicles/2708.svg"
          }
        ]
      },
      ...
      {
        text: "cruise ship",
        src: "vehicles/1f6f3.svg"
      },

      {
        text: "kick scooter",
        src: "vehicles/1f6f4.svg"
      },

      {
        text: "scooter",
        src: "vehicles/1f6f5.svg"
      },

      {
        text: "canoe",
        src: "vehicles/1f6f6.svg"
      },

      {
        text: "ferry",
        src: "vehicles/26f4.svg"
      },

      {
        text: "sailboat",
        src: "vehicles/26f5.svg"
      }
    ]
  },
  {
    question: "Jessica travels to",
    answers: [
      {
        text: "Norway",
