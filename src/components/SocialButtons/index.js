    ...
    return (
      <Fragment>
        ...
        <div className="row social-row justify-content-center">
          ...
          <a
            href="mailto:?subject=Survey on emoji passwords&amp;body=Can emojis replace passwords? In order to support research on emoji passwords, take this short survey (3-5 minutes): https://emojistory.site."
